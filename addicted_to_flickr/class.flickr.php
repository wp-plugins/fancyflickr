...
* Originally written by John Nunemaker <nunemaker@gmail.com> http://addictedtonew.com
* 
* @author Josh Betz <j@joshbetz.com>
* @link http://joshbetz.com/11/09/addictedtoflickr
* @access public
* @version 1.3
*/
class flickr {
	...
	* @access private 
    */
	var $_flickr_api_url = 'http://api.flickr.com/services/rest/';
	...
	* @access public
	*/
	function getGroupPhotos($group_id, $page=1, $per_page=10, $tags='', $extras='license, date_upload, date_taken, owner_name, icon_server, url_o, url_m, url_s, url_t, url_sq') {
		$ret_array 	= array();
	...
	* @access public
	*/
	function getUsersPublicPhotos($user_id, $page=1, $per_page=10, $extras='license, date_upload, date_taken, owner_name, icon_server, url_o, url_m, url_s, url_t, url_sq') {
		$ret_array 	= array();
	...
	*/
	function photoSearch(	$user_id='', $tags='', $per_page=100, $page=1, $sort='date-posted-desc', $tag_mode='any', 
		...
		$found 				= array();
		$extras				= 'license, date_upload, date_taken, owner_name, icon_server, url_o, url_m, url_s, url_t, url_sq';
	...
	* @access public
	*/
	function getPhotosetPhotos($user_id, $photoset_id, $num = '500') {
		$ret_array 	= array();
		
		// make request to flickr
		$data = $this->makeRequest('flickr.photosets.getPhotos', array('photoset_id' => $photoset_id, 'extras'=>'url_o, url_m, url_s, url_t, url_sq', 'per_page'=>$num));
